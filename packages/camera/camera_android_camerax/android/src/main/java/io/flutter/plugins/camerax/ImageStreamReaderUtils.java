...
public class ImageStreamReaderUtils {
    ...
    public ByteBuffer yuv420ThreePlanesToNV21(
            @NonNull ImageProxy.PlaneProxy[] yuv420888planes, int width, int height) {
     ...
     * <p>https://github.com/googlesamples/mlkit/blob/master/android/vision-quickstart/app/src/main/java/com/google/mlkit/vision/demo/BitmapUtils.java
     */
    private static boolean areUVPlanesNV21(@NonNull ImageProxy.PlaneProxy[] planes, int width, int height) {
        int imageSize = width * height;
    ...
    private static void unpackPlane(
            @NonNull ImageProxy.PlaneProxy plane, int width, int height, byte[] out, int offset, int pixelStride)
